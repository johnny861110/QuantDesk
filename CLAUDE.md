...
This project is indexed by GitNexus as **QuantDesk** (3990 symbols, 8008 relationships, 223 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
